...
import fantasygame.arena.Battle;
...
public class TestBattle {
    ...
    public void testFightFirstWarriorWin() {
        ...
        elf = new Elf("elfName", 200, 1, new Axe(1, 20), new PlateArmour(20));
        expected = dwarf;
    ...
    public void testFightSecondWarriorWin() {
        dwarf = new Dwarf("dwarfName", 20, 1, new Axe(1, 20), new PlateArmour(20));
